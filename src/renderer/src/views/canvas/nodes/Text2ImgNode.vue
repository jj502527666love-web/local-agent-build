<template>
  <div class="canvas-node canvas-node-wide" :style="{ borderColor: '#f59e0b' }" :data-status="data.status">
    ...
    <div class="node-body">
      ...
      <div v-if="data.status === 'done' && data.ref_image_count" class="text-[10px] text-amber-700 bg-amber-50 border border-amber-200 rounded px-1.5 py-0.5 mb-2 inline-flex items-center gap-1">
